import { ListTabsResult, type Tab } from "@reins/protocol";
import { z } from "zod";
 ...
 * browser (explicit browserId / the only browser / ambiguity error).
 */
export async function handleRpc(bridge: BridgePort, body: unknown): Promise<unknown> {
